...
public class UsuarioController {
    ...
    @PostMapping("/register") // Agregar lógica para guardar el nuevo usuario en la lista o en la base de datos.
    public ResponseEntity<String> registerUser(@RequestBody Usuario nuevoUsuario) {
        ...
        // Agregar el nuevo usuario a la lista en memoria y guardarlo en el archivo
    ...
    private void saveInFile(Usuario usuario) {
        try (FileWriter writer = new FileWriter("usuarios.txt", true)) {
        	// Escribir el nombre y la contraseña del usuario en el archivo
    ...
    public ResponseEntity<String> updatePassword(
     ...
     // Actualizar la contraseña en el archivo si el usuario existe
    ...
    public ResponseEntity<String> deleteUser(@RequestBody Usuario usuario) {
    	// Eliminar el usuario del archivo si existe
    ...
    // Función para actualizar el archivo después de eliminar un usuario
    ...
    public ResponseEntity<String> decrementarContadorCierres() {
    	// Decrementar el contador de sesiones si es mayor que cero
    	if (contador>0) {
        contador--;
    	}else {
    	contador = 0;
