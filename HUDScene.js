...
*/
    ...
    this.health1Text = this.add.text(22, 23, '', { fontSize: '15px', fill: '#fff' });
    this.exp1Text = this.add.text(80, 23, '', { fontSize: '15px', fill: '#fff' });
    this.health2Text = this.add.text(22, 75, '', { fontSize: '15px', fill: '#fff' });
    this.exp2Text = this.add.text(80, 75, '', { fontSize: '15px', fill: '#fff' });
